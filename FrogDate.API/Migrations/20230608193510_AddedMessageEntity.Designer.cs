...
namespace FrogDate.API.Migrations
{
    ...
    [Migration("20230608193510_AddedMessageEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrogDate.API.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FrogDate.API.Models.Message", b =>
                {
                    b.HasOne("FrogDate.API.Models.User", "Recipient")
                        .WithMany("MessagesRecived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FrogDate.API.Models.User", "Sender")
